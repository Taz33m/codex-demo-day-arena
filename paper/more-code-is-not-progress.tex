...
% Layout tuning for the PDF artifact: keep the paper compact, but give
% paragraphs, lists, captions, and tables enough air to read cleanly.
\setlength{\parindent}{0pt}
\setlength{\parskip}{0.55em}
\setlength{\abovecaptionskip}{0.6em}
\setlength{\belowcaptionskip}{0.25em}
\renewcommand{\arraystretch}{1.16}
\setlist{leftmargin=1.45em,itemsep=0.18em,topsep=0.35em}
...
\title{\textbf{More Code Is Not Progress}\\[0.65em]
...
Prior software-engineering agent work has emphasized real repository tasks and agent-computer interfaces \cite{jimenez2024swebench,yang2024sweagent}. This paper shifts the unit of analysis from resolving one issue or completing one task to governing a portfolio of product candidates.
...
\begin{table}[!htbp]
\centering
\begin{tabularx}{\linewidth}{>{\ttfamily}l Y Y}
\toprule
...
The architecture is compatible with the broader line of work on LLM agents acting in external environments \cite{yao2023react,liu2024agentbench}, but it adds an explicit portfolio-governance layer: candidate state, compute allocation, proof priority, and no-winner stopping.
...
The buyer judge is synthetic. That limitation is central to the system. LLM-as-judge methods can approximate some preference judgments, but they carry known biases and cannot replace human or market evidence \cite{zheng2023llmjudge}. The correct claim is that 19 candidates were classified as buyer-compelling under synthetic rubric-based review. The paper does not claim that 19 products were market validated.
...
\begin{longtable}{L{0.22\linewidth} L{0.31\linewidth} L{0.33\linewidth}}
\toprule
...
\newblock arXiv:2405.15793, 2024. \url{https://arxiv.org/abs/2405.15793}.

\bibitem{liu2024agentbench}
Xiao Liu et al.
\newblock AgentBench: Evaluating LLMs as Agents.
\newblock \emph{ICLR}, 2024. \url{https://arxiv.org/abs/2308.03688}.

\bibitem{zheng2023llmjudge}
Lianmin Zheng et al.
\newblock Judging LLM-as-a-Judge with MT-Bench and Chatbot Arena.
\newblock \emph{NeurIPS Datasets and Benchmarks Track}, 2023. \url{https://arxiv.org/abs/2306.05685}.

\bibitem{liang2023helm}
Percy Liang et al.
\newblock Holistic Evaluation of Language Models.
\newblock arXiv:2211.09110, 2022. \url{https://arxiv.org/abs/2211.09110}.

\bibitem{yao2023react}
Shunyu Yao, Jeffrey Zhao, Dian Yu, Nan Du, Izhak Shafran, Karthik Narasimhan, and Yuan Cao.
\newblock ReAct: Synergizing Reasoning and Acting in Language Models.
\newblock \emph{ICLR}, 2023. \url{https://arxiv.org/abs/2210.03629}.
